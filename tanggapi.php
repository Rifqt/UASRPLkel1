						...
						<form action="" method="POST">
							...
							<div class="form-group">
								<select name="id_petugas" id="petugas" class="form-control">
									...
									<option value="1">Yildi Andriana</option>
									<option value="1">Sarah Nurul Yakin</option>
									<option value="1">Ramadan Nurwahid</option>
									<option value="1">Rifqi Taupik</option>
									<option value="1">Sabrin</option>
									<option value="1">Pilar Ilham</option>
								</select>
							</div>
